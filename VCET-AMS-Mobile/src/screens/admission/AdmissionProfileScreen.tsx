  ...
  return (
    <ScrollView className="flex-1" style={{ backgroundColor: colors.bg }} contentContainerStyle={{ padding: 16 }}>
      <View className="items-center mb-6 mt-4">
        <View className="w-20 h-20 rounded-full bg-cyan-600 items-center justify-center mb-3">
      ...
      <Card className="mb-4">
        ...
        <View className="gap-2">
          <InfoRow label="Role" value="Admission Cell" colors={colors} />
          <InfoRow label="Institution" value="VCET Puttur" colors={colors} />
      ...
      <Card className="mb-4">
        ...
        <View className="flex-row items-center justify-between py-2">
          ...
          <Switch
            ...
            trackColor={{ false: colors.border, true: colors.accentAdmission }}
...
export default AdmissionProfileScreen;
